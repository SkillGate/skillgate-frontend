...
const AboutItem = ({ data }) => {
  return (
    <div>
      <div className="p-4 bg-white dark:bg-dark-card rounded-sm shadow-md transition-transform ease-in-out duration-300 hover:scale-110 hover:shadow-sm hover:shadow-purple-400/50 h-80 w-70">
